...
const Login = () => {
  ...
  return (
    <div className="relative flex flex-col justify-center items-center min-h-[calc(100vh-64px)] bg-gray-50 dark:bg-gray-900 px-4">
      ...
      >
        <span className="material-symbols-outlined text-[20px] transition-transform group-hover:scale-110 text-primary">
          arrow_back
        </span>
        <span className="bg-clip-text text-transparent bg-linear-to-r from-blue-600 via-purple-500 to-pink-500 dark:from-blue-400 dark:via-purple-400 dark:to-pink-400">
          Back to Home
        </span>
      </Link>
      ...
      <div className="w-full max-w-md p-8 space-y-6 bg-white dark:bg-gray-800/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-gray-100 dark:border-white/5 dark:border-t-white/10">
        <div className="text-center">
          <h2 className="text-3xl font-bold bg-clip-text text-transparent bg-linear-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400">
            Welcome Back
          </h2>
